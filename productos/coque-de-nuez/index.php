<?php
  ...
  $pageId   = 'coque-de-nuez';  // Cambiado de 'quienes-somos' a 'coque-de-nuez'
                ...
                <div class="col-xxl-12 col-lg-12">
                    <div class="page-single mb-40">
                        ...
                        <div class="page-content">
                            ...
                            <h4 class="fw-semibold mb-25"><?php echo translate('specs_title'); ?></h4>
                            <div class="row gy-3">
                                <div class="col-xl-6">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <p class="text-justify"><?php echo translate('process_description'); ?></p>
                                </div>
                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="checklist style5">
                                        <ul>
                                            ...
                                            <li><?php echo translate('size_4'); ?></li>
                                            <li><?php echo translate('size_5'); ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
