                ...
                <div class="col-xxl-12 col-lg-12">
                    <div class="page-single mb-40">
                        <div class="page-content">
                            <h2 class="page-title fw-semibold">Coque 20x80 mm</h2>
                            <p class="mb-30 text-justify">El Coque 20x80 mm es un producto de alta calidad con especificaciones técnicas optimizadas para procesos industriales que requieren granulometría gruesa.</p>
                            
                            <div class="row gy-3">
                                <div class="col-xl-6">
                                    <h4 class="fw-semibold">Especificaciones Técnicas</h4>
                                    <p class="mb-30 text-justify">
                                        Nuestro Coque 20x80 mm cumple con los más altos estándares de calidad para garantizar un rendimiento óptimo en sus procesos industriales.
                                    </p>
                                </div>
                                <div class="col-xl-6">
                                    ...
                                    <div class="checklist style5">
                                        <ul>
                                            <li>Humedad: 1% máx</li>
                                            <li>Ceniza: 12,5% máx</li>
                                            <li>Materia Volátil: 1,4% máx</li>
                                            <li>Azufre: 0,71%</li>
                                            <li>Carbono Fijo: 86,1%</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="checklist style5">
                                        <ul>
                                            ...
                                            <li>Aplicaciones que requieren granulometría gruesa</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
