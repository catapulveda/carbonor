                    ...
                    <div class="page-single mb-40">
                        <div class="page-content">
                            ...
                            <div class="row gy-3">
                                <div class="col-xl-6">
                                    ...
                                    <p class="mb-30 text-justify">
                                        Nuestro Coque 10x30 mm cumple con los más altos estándares de calidad para garantizar un rendimiento óptimo en sus procesos industriales.
                                    </p>
                                </div>
                                <div class="col-xl-6">
                            ...
                            <div class="row gy-40 align-items-center">
                                <div class="col-xl-6">
                                    <div class="page-img">
                                        <img src="/assets/img/carbonor/servicios/10x030_856x450.webp" alt="Coque 10x30 mm">
                                    </div>
                                </div>
                                <div class="col-xl-6">
                                    <div class="checklist style5">
                                        <ul>
                                            ...
                                            <li>Aplicaciones industriales especializadas</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
