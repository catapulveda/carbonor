...
<body class="">
	...
	******************************** -->
            ...
            <div class="swiper hero-slider12" id="heroSlide12">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="th-hero-bg" data-overlay="title" data-opacity="1" data-bg-src="/assets/img/carbonor/fondoprincipal.webp">
                    ...
                    <!-- Slide 2 -->
                    <div class="swiper-slide">
                        <div class="th-hero-bg" data-overlay="title" data-opacity="1" data-bg-src="/assets/img/carbonor/fondoprincipal1.webp">
                            <img src="assets/img/hero/hero_bg_overlay12_1.png" alt="imagen">
                        </div>
                        <div class="container">
                            <div class="hero-style12 text-center">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="service-card style3">
                            ...
                            <div class="service-img img-shine">
                                <img src="/assets/img/carbonor/3.webp" alt="img">
                    ...
                    <div class="swiper-slide">
                        <div class="service-card style3">
                            ...
                            <div class="service-img img-shine">
                                <img src="/assets/img/carbonor/5.webp" alt="img">
                                <!-- <a href="service-details.html" class="icon-btn">
                                    <img src="assets/img/icon/arrow-right.svg" alt="img">
                                </a> -->
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card style3">
                            ...
                            <div class="service-img img-shine">
                                <img src="/assets/img/carbonor/4.webp" alt="img">
                                <!-- <a href="service-details.html" class="icon-btn">
                                    <img src="assets/img/icon/arrow-right.svg" alt="img">
                                </a> -->
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card style3">
                            ...
                            <div class="service-img img-shine">
                                <img src="/assets/img/carbonor/6.webp" alt="img">
                                <!-- <a href="service-details.html" class="icon-btn">
                                    <img src="assets/img/icon/arrow-right.svg" alt="img">
                                </a> -->
                            </div>
        ...
        <div class="container th-container2">
            <ul class="about-3-thumb-list">
                <li class="gallery-card">
                    <a class="popup-image jump" href="/assets/img/carbonor/15.webp">
                        <img src="/assets/img/carbonor/8.webp" alt="img">
                        <i class="fal fa-plus"></i>
                    </a>
                </li>
                <li class="gallery-card">
                    <a class="popup-image jump-reverse" href="/assets/img/carbonor/18.webp">
                        <img src="/assets/img/carbonor/9.webp" alt="img">
                        <i class="fal fa-plus"></i>
                    </a>
                </li>
                <li class="gallery-card">
                    <a class="popup-image jump-reverse" href="/assets/img/carbonor/14.webp">
                        <img src="/assets/img/carbonor/10.webp" alt="img">
                        <i class="fal fa-plus"></i>
                    </a>
                </li>
                <li class="gallery-card">
                    <a class="popup-image" href="/assets/img/carbonor/17.webp">
                        <img src="/assets/img/carbonor/11.webp" alt="img">
                        <i class="fal fa-plus"></i>
                    </a>
                </li>
                <li class="gallery-card">
                    <a class="popup-image jump" href="/assets/img/carbonor/13.webp">
                        <img src="/assets/img/carbonor/7.webp" alt="img">
                        <i class="fal fa-plus"></i>
                    </a>
                </li>
            </ul>
        ...
        <div class="container th-container2">
            <div class="row justify-content-lg-between align-items-center">
                <div class="col-xxl-6 col-xl-7 col-lg-6">
                    <div class="title-area">
                        <span class="sub-title text-title">Our Projects</span>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="portfolio-card style3">
                                ...
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="service-details.html">01. Manufacturing Work</a></h3>
                                    <p class="portfolio-text">Industrial services cover a broad range of solutions aimed at improving operations, increasing productivity, and ensuring safety across various industries.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style3">
                                ...
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="service-details.html">02. Construction Work</a></h3>
                                    <p class="portfolio-text">Industrial services cover a broad range of solutions aimed at improving operations, increasing productivity, and ensuring safety across various industries.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style3">
                                ...
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="service-details.html">03. Oil & Gas Factory</a></h3>
                                    <p class="portfolio-text">Industrial services cover a broad range of solutions aimed at improving operations, increasing productivity, and ensuring safety across various industries.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="portfolio-card style3">
                                ...
                                <div class="portfolio-content">
                                    <h3 class="portfolio-title"><a href="service-details.html">04. Factories & plants</a></h3>
                                    <p class="portfolio-text">Industrial services cover a broad range of solutions aimed at improving operations, increasing productivity, and ensuring safety across various industries.</p>
                                </div>
                            </div>
                        </div>
    ...
    Video Area  
    ==============================-->
   <div class="video-area-2 space overflow-hidden" data-bg-src="/assets/img/carbonor/8.webp" id="contact-sec" data-overlay="black2" data-opacity="5">
        <div class="container th-container2">
        ...
        <div class="container th-container2">
            <div class="row justify-content-lg-between align-items-center">
                <div class="col-xxl-6 col-lg-7">
                    <div class="title-area">
                        <span class="sub-title text-title">Testimonial</span>
                        ...
                        <div class="testi-card style3 bg-smoke3">
                            ...
                            <div class="testi-card_profile">
                                ...
                                <div class="testi-card_profile-details">
                                    ...
                                    <span class="testi-card_desig">Civil Engineer</span>
                                </div>
                            </div>
            ...
            <div class="row justify-content-lg-between align-items-center">
                <div class="col-xxl-4 col-lg-6">
                    <div class="title-area">
                        ...
                        <p class="text-white">Builda help you easily create a industrial trading website. With the function Register, Login, Post industrial news.</p>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn">
                        <a href="team.html" class="th-btn style4 th-btn-icon">View All Team</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container th-container2">
            <div class="row justify-content-lg-between align-items-center">
                <div class="col-xxl-5 col-xl-6 col-lg-7">
                    <div class="title-area">
                        <span class="sub-title text-title">News & Blog</span>
                        <h2 class="sec-title">Read Our Insights</h2>
                        <p class="sec-text">Architects and engineers collaborate to create detailed design plans that translate concepts into feasible structures. </p>
                    </div>
                </div>
                <div class="col-auto">
                    <div class="sec-btn">
                        ...
                        <div class="swiper-slide">
                            <div class="blog-card style3">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3 class="box-title"><a href="blog-details.html">Living sustainability: A day in the life at builda residence</a></h3>
                                    <a href="blog-details.html" class="th-btn style-border2 th-btn-icon">Read More</a>
                                </div>
                            </div>
                        </div>
